...
input_file <- "data/working/plasticitygs_reformat.csv"
...
write.csv(
  all_results_df,
  file.path(output_dir, "model_fitting_results_gs.csv"),
  row.names = FALSE
)
saveRDS(all_results_r, file.path(output_dir, "model_fitting_results_full_gs.RDS"))
